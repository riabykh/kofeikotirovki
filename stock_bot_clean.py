...
Focus on high-impact news that would be most relevant to investors and traders in this sector."""
...
🔔 {self.get_text(user.id, 'all_notified')}
    ...
    def schedule_daily_summaries(self):
        """Schedule daily AI-powered summaries"""
    ...
    async def start(self):
        ...
        # Start polling for updates and scheduler
